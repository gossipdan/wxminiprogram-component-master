// plugin/components/cutvideo/cutvideo.js
...
Component({
  ...
  attached: function () {
    this.startMove = 0;
    let data = this.properties.videoOptions,
  ...
  ready: function(){
    wx.createSelectorQuery().select('.mask_img').boundingClientRect((rect) => {
  ...
  methods: {
    ...
    confirm_edit:function(){
      ...
      this.triggerEvent('confirm',{videoOptions:data})
    }
  }
})
